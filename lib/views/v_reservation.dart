...
class _CardScreenState extends State<CardScreen> {
              ...
              Expanded(
                  child: reservations.isEmpty
                    ...
                    scheduleViewSettings: ScheduleViewSettings(
                      hideEmptyScheduleWeek: true, monthHeaderSettings: MonthHeaderSettings(
  ...
  List<Meeting>  _getDataSource() {
    ...
    reservations.forEach((element) {
      ...
      DateTime resultat1 = datePresenceDateTime.add(
          Duration(hours: heuresDebut, minutes: minutesDebut));
      DateTime resultat2 = datePresenceDateTime2.add(
          Duration(hours: heuresFin, minutes: minutesFin));
      // print("resultat1");
      ...
      meetings.add(
          Meeting(eventName: element.cour.toString(),
